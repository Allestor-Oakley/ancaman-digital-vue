  ...
  data() {
    return {
      ...
      judul : {
        ...
        color2 : "#bf80ff",
        title : "Hoax",
        context : "Informasi palsu, berita bohong, atau fakta yang dipelintir atau direkayasa untuk tujuan lelucon hingga tujuan serius."
      },
      contohKasus : {
        items: [
          {
      ...
      penanganan : {
        ...
        content : [
          ...
          'Perkirakan siapa yang mungkin ada dibalik hoax tersebut, waspadai pihak-pihak tersebut',
          'Cari informasi dari sudut pandang dan sumber lain untuk mencegah subjektivitas',
        ]
      }
    }
  }
